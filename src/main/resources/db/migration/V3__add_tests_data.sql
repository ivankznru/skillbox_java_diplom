...
VALUES ('1', '1', 'ACCEPTED', 1, 1, '2020-12-31 18:00:07', 'О миграции БД',
       ...
       ('7', '1', 'ACCEPTED', 1, 5, '2021-04-13 18:04:07',
        ...
        '4'),
       ('8', '1', 'ACCEPTED', 1, 3, '2021-04-13 18:05:07', 'Исследование: какие способы обхода антивирусов используют хакеры',
       ...
       ('13', '1', 'ACCEPTED', 1, 3, '2021-05-16 18:08:07', 'Как добавить Natural Language Processing в Minecraft',
        ...
        '23'),
       ('14', '1', 'ACCEPTED', 1, 4, '2021-05-17 18:08:07', 'Исследование: люди могут научиться «эхолокации» за 10 недель',
       ...
       ('15', '1', 'ACCEPTED', 1, 5, '2021-05-18 18:08:07', 'Поддержку NVMe предложат для жестких дисков',
        ...
        '20'),
       ('16', '1', 'ACCEPTED', 1, 5, '2021-05-19 18:08:07', '«Яндекс» представил список слов, дающий представление о региональном разнообразии русского языка',
