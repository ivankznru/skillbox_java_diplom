...
insert into posts(is_active, status, moderator_id, user_id, time, title, text, view_count)
VALUES ('1', 'NEW', 1, 2, '2021-04-11 18:02:07', 'Книга «Современный скрапинг веб-сайтов с помощью Python. 2-е межд. издание»',
...
insert into posts(is_active, status, moderator_id, user_id, time, title, text, view_count)
VALUES ('1', 'NEW', 1, 4, '2021-04-11 18:03:07', 'За что вы так меня не любите?» (с) Python',
...
insert into posts(is_active, status, moderator_id, user_id, time, title, text, view_count)
VALUES ('1', 'NEW', 1, 5, '2021-04-11 18:04:07', 'Как считывать и удалять метаданные из ваших фотографий с помощью Python',
...
insert into posts(is_active, status, moderator_id, user_id, time, title, text, view_count)
VALUES ('1', 'NEW', 1, 3, '2021-04-11 18:05:07', 'Исследование: какие способы обхода антивирусов используют хакеры',
...
insert into posts(is_active, status, moderator_id, user_id, time, title, text, view_count)
VALUES ('1', 'NEW', 1, 4, '2021-04-11 18:06:07', 'Kubernets 1.21 — неожиданно много изменений…',
...
insert into posts(is_active, status, moderator_id, user_id, time, title, text, view_count)
VALUES ('1', 'NEW', 1, 5, '2021-04-11 18:07:07', 'Создаем Booking приложение с Webix UI',
...
insert into posts(is_active, status, moderator_id, user_id, time, title, text, view_count)
VALUES ('1', 'NEW', 1, 1, '2021-04-11 18:08:07', 'Как я делал матчер правил возврата автобусных билетов',
        'Мы тут автоматизируем автобусы, недавно вот с нашей помощью все билеты в России стали электронными.',
        '55');

insert into posts(is_active, status, moderator_id, user_id, time, title, text, view_count)
VALUES ('1', 'NEW', 1, 2, '2021-04-11 18:09:07', 'Адаптация подхода с применением сжатия zlib для отсеивания некачественных текстов разной длины',
